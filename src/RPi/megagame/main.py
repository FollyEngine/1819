...
two = Adafruit_NeoPixel(1, 21, LED_FREQ_HZ, LED_DMA, LED_INVERT, LED_BRIGHTNESS, 0)
one.begin()
two.begin()
...
play({'direction': "one", 'operation': 'set', "colour": "red", "count": 16})
play({'direction': "two", 'operation': 'set', "colour": "green", "count": 1})

time.sleep(3)

play({'direction': "one", 'operation': 'set', "colour": "blue", "count": 8})
play({'direction': "two", 'operation': 'set', "colour": "off", "count": 1})
